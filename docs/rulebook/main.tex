...
\begin{tikzpicture}[remember picture,overlay]
  ...
  \node[rotate=-62] at ($(current page.south west)+(2.35in,4.55in)$) {\includegraphics[width=2.75in]{../../app/assets/images/ships/tactical/aurelian_cruiser.png}};
  \node[rotate=62] at ($(current page.south west)+(6.2in,4.45in)$) {\includegraphics[width=2.55in]{../../app/assets/images/ships/tactical/kestrel_cruiser.png}};
